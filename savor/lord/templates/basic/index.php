<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">Migtmedia</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li class="divider"></li>
					<li>
						<a href="Atsijungti"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
					</li>
				</ul>
				<!-- /.dropdown-user -->
			</li>
...
<script src="savor/lord/templates/basic/js/jquery-1.10.2.js"></script>
<script src="savor/lord/templates/basic/js/bootstrap.min.js"></script>
<script src="savor/lord/templates/basic/js/plugins/metisMenu/jquery.metisMenu.js"></script>

<!-- Page-Level Plugin Scripts - Dashboard -->
<script src="savor/lord/templates/basic/js/plugins/morris/raphael-2.1.0.min.js"></script>
<script src="savor/lord/templates/basic/js/plugins/morris/morris.js"></script>

<!-- SB Admin Scripts - Include with every page -->
<script src="savor/lord/templates/basic/js/sb-admin.js"></script>

<!-- Page-Level Demo Scripts - Dashboard - Use for reference -->
<script src="savor/lord/templates/basic/js/demo/dashboard-demo.js"></script>
